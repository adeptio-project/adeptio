...
RESOURCES += src/qt/adeptio.qrc src/qt/adeptio_locale.qrc

TRANSLATIONS += src/qt/locale/adeptio_bg.ts \
                src/qt/locale/adeptio_de.ts \
                src/qt/locale/adeptio_en.ts \
                src/qt/locale/adeptio_es.ts \
                src/qt/locale/adeptio_fi.ts \
                src/qt/locale/adeptio_fr.ts \
                src/qt/locale/adeptio_it.ts \
                src/qt/locale/adeptio_ja.ts \
                src/qt/locale/adeptio_pl.ts \
                src/qt/locale/adeptio_pt.ts \
                src/qt/locale/adeptio_ru.ts \
                src/qt/locale/adeptio_sk.ts \
                src/qt/locale/adeptio_sv.ts \
                src/qt/locale/adeptio_vi.ts \
                src/qt/locale/adeptio_zh_CN.ts \
                src/qt/locale/adeptio_zh_TW.ts
