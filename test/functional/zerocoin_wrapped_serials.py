#!/usr/bin/env python3
# Copyright (c) 2019 The Adeptio Core developers
...
from fake_stake.base_test import ADE_FakeStakeTest

class zADEwrappedSerialsTest(ADE_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zADEs..." % DENOM_TO_USE)
