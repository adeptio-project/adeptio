...
In order to support loading of multiple wallets in adeptio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is adeptio.cpp.
...
Changes to adeptio.cpp
----------------------
adeptio.cpp is the entry point into adeptio-qt, and as such, will require some minor modifications to provide hooks for
