...
```
./adeptiod -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
-externalip=X   You can tell adeptio about its publicly reachable address using
                ...
                /var/lib/tor/adeptio-service/hostname. Onion addresses are given
...
```
./adeptiod -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
