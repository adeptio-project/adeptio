...
VIAddVersionKey ProductName "ADE Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-adeptio executable and locales:
    Delete /REBOOTOK $INSTDIR\adeptio.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\adeptio-qt.exe
    ...
    WriteRegStr HKCR "adeptio" "" "URL:ADE"
    WriteRegStr HKCR "adeptio\DefaultIcon" "" $INSTDIR\adeptio-qt.exe
    WriteRegStr HKCR "adeptio\shell\open\command" "" '"$INSTDIR\adeptio-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\adeptio-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\ADE.lnk"
