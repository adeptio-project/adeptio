...
#   c) node1 mines 32 blocks, so now node 0 has 60001XLQ, node 1 has 4250XLQ, node2 has none.
#   d) node0 sends 601 XLQ to node2, in two transactions (301 XLQ, then 300 XLQ).
