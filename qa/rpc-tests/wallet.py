...
#   c) node1 mines 32 blocks, so now node 0 has 60001ADE, node 1 has 4250ADE, node2 has none.
#   d) node0 sends 601 ADE to node2, in two transactions (301 ADE, then 300 ADE).
