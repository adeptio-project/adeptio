...
#ifndef ADE_ZADETRACKER_H
#define ADE_ZADETRACKER_H
...
public:
    CzADETracker(std::string strWalletFile);
    ~CzADETracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzADEWallet* zADEWallet = NULL);
