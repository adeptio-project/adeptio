...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the XLQ and zADE money supply statistics") + " " + _("on startup"));
...
//    strUsage += "  -anonymizeadeptioamount=<n>     " + strprintf(_("Keep N XLQ anonymized (default: %u)"), 0) + "\n";
