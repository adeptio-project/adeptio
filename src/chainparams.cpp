...
static Checkpoints::MapCheckpoints mapCheckpoints = 
    ...
    (0, uint256("0x00000b67abd9db69a4aef47c2e4cda09303033afb08b39f9b6fa87b7be8794d8")); 
 
 
 
static const Checkpoints::CCheckpointData data = { 
    &mapCheckpoints, 
    1557858248, // * UNIX timestamp of last checkpoint block 
...
public: 
    ...
    { 
        ...
        nZerocoinStartHeight = 9999999; // 9M 
        nZerocoinStartTime = 1597858248; 
        ...
        nBlockEnforceInvalidUTXO = 9999999; //Start enforcing the invalid UTXO's 
        nInvalidAmountFiltered = 268200*COIN; //Amount of invalid coins filtered through exchanges, that should be considered valid 
        nBlockZerocoinV2 = 46; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT 
    ...
    vSeeds.push_back(CDNSSeedData("seed0.adeptio.cc", "seed0.adeptio.cc")); // Primary DNS Seeder; 
        ...
        nStartMasternodePayments = 1558116000; // After 1 day from init start  
