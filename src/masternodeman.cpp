...
// Copyright (c) 2018-2019 The Adeptio developers// Copyright (c) 2015-2017 The PIVX developers
    ...
    // Light version for OLD MASSTERNODES - fake pings, no self-activation
        ...
        if (fAcceptable) {
            ...
            if (mi != mapBlockIndex.end() && (*mi).second) {
                CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 10000 ADE tx -> 1 confirmation
