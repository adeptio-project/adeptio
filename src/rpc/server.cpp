...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"adeptio", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"adeptio", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"adeptio", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"adeptio", "masternodecurrent", &masternodecurrent, true, true, false},
        {"adeptio", "masternodedebug", &masternodedebug, true, true, false},
        {"adeptio", "startmasternode", &startmasternode, true, true, false},
        {"adeptio", "createmasternodekey", &createmasternodekey, true, true, false},
        {"adeptio", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"adeptio", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"adeptio", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"adeptio", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"adeptio", "getmasternodescores", &getmasternodescores, true, true, false},
        {"adeptio", "mnbudget", &mnbudget, true, true, false},
        {"adeptio", "preparebudget", &preparebudget, true, true, false},
        {"adeptio", "submitbudget", &submitbudget, true, true, false},
        {"adeptio", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"adeptio", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"adeptio", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"adeptio", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"adeptio", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"adeptio", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"adeptio", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"adeptio", "checkbudgets", &checkbudgets, true, true, false},
        {"adeptio", "mnsync", &mnsync, true, true, false},
        {"adeptio", "spork", &spork, true, true, false},
        {"adeptio", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzADEseed", &getzADEseed, false, false, true},
        {"zerocoin", "setzADEseed", &setzADEseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzADE", &searchdzADE, false, false, true},
        {"zerocoin", "dzADEstate", &dzADEstate, false, false, true}
...
{
    return "> adeptio-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9077/\n";
}
