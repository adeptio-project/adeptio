...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"adeptio", "masternodelist", &masternodelist, true, true, false},
        {"adeptio", "mnbudget", &mnbudget, true, true, false},
        {"adeptio", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
...
#ifdef ENABLE_WALLET
        {"adeptio", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use adeptiod, or the -server option to adeptio-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
