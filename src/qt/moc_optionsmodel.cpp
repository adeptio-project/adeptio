...
QT_MOC_LITERAL(5, 60, 25), // "anonymizeADEAmountChanged"
QT_MOC_LITERAL(6, 86, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "DarksendRoundsChanged\0anonymizeADEAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->anonymizeADEAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeADEAmountChanged)) {
                *result = 2;
            }
        }
        {
...
// SIGNAL 2
void OptionsModel::anonymizeADEAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
