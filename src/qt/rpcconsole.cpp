                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzADEPathCustom = GetArg("-zADEbackuppath", "");
    ...
    if(!strzADEPathCustom.empty()) {
        ui->wallet_customzADEbackuppath->setText(QString::fromStdString(strzADEPathCustom));
        ui->wallet_customzADEbackuppath_label->setVisible(true);
        ui->wallet_customzADEbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzADEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Adeptio RPC console.") + "<br>" +
