                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Adeptio Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ADE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and adeptio: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zADE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Adeptio Core"), this);
    aboutAction->setStatusTip(tr("Show information about Adeptio Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ADE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ADE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ADE addresses"));
    ...
    openAction->setStatusTip(tr("Open a ADE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Adeptio Core help message to get a list with possible ADE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Adeptio Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ADE network", "", count));
}
...
{
    QString strTitle = tr("Adeptio Core"); // default title
