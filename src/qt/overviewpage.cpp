                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    QString automintHelp = tr("Current percentage of zADE.\nIf AutoMint is enabled this percentage will settle around the configured AutoMint percentage (default = 10%).\n");
    bool fEnableZeromint = GetBoolArg("-enablezeromint", true);
    int nZeromintPercentage = GetArg("-zeromintpercentage", 10);
    if (fEnableZeromint) {
        automintHelp += tr("AutoMint is currently enabled and set to ") + QString::number(nZeromintPercentage) + "%.\n";
        automintHelp += tr("To disable AutoMint add 'enablezeromint=0' in adeptio.conf.");
    }
    else {
        automintHelp += tr("AutoMint is currently disabled.\nTo enable AutoMint change 'enablezeromint=0' to 'enablezeromint=1' in adeptio.conf");
    }
    ...
    // ADE Available
    bool showADEAvailable = settingShowAllBalances || pivAvailableBalance != nTotalBalance;
    ...
    bool showzADEUnconfirmed = settingShowAllBalances || unconfirmedZerocoinBalance != 0;
    bool showzADEImmature = settingShowAllBalances || immatureZerocoinBalance != 0;
    ui->labelzBalanceMature->setVisible(showzADEAvailable);
    ui->labelzBalanceMatureText->setVisible(showzADEAvailable);
    ui->labelzBalanceUnconfirmed->setVisible(showzADEUnconfirmed);
    ui->labelzBalanceUnconfirmedText->setVisible(showzADEUnconfirmed);
    ui->labelzBalanceImmature->setVisible(showzADEImmature);
    ui->labelzBalanceImmatureText->setVisible(showzADEImmature);
