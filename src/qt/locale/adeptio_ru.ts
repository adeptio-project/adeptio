...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса ADE для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса ADE для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес ADE</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и adeptio: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изменить параметры конфигурации ADE</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами ADE, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами ADE</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть adeptio: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать помощь о Adeptio Core со списком возможных параметров командной строки</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью ADE</numerusform><numerusform>%n активных соединения с сетью ADE</numerusform><numerusform>%n активных соединений с сетью ADE</numerusform><numerusform>%n активных соединений с сетью ADE</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом ADE.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где Adeptio Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>Adeptio Core скачает и сохранит копию цепочки блоков. Как минимум %1ГБ данных будет храниться в этом каталоге и размер данных будет со временем расти. В этом же каталоге будет сохранён кошелёк.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Сумма постоянно анонимизированных ADE</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети ADE через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для клиента ADE на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска ADE.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью ADE после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик adeptio: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес ADE либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл ADE из текущего каталога данных. Для больших лог-файлов эта операция может занять несколько секунд.</translation>
    </message>
    <message>
        <source>&amp;Open</source>
    ...
    <message>
        ...
        <translation>Добро пожаловать в RPC-консоль ADE.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть ADE.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть ADE.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес ADE</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес ADE для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К adeptio: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть ADE.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес ADE, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом ADE</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес ADE, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified ADE address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом ADE</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, Adeptio Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось привязаться к %s на этом компьютере. Возможно, Adeptio Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к  ADE (Мастерноды, Obfuscate, HyperSend, бюджеты) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "ADE Alert" admin@foo.com
        ...
        <translation>Для использования adeptiod или опции -server с adeptio-qt, вы должны установить опцию rpcpassword в конфигурационном файле:
%s
...
Например: alertnotify=echo %%s | mail -s "ADE Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: пожалуйста, убедитесь что дата и время на Вашем компьютере выставлены правильно! Adeptio Core не сможет работать корректно, если часы настроены неверно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>(9077 можно использовать только в главной сети)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: кошелёк требует более новой версии Adeptio Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверка на непротиворечивость закончилась неудачно. Adeptio Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать кошелёк: перезапустите Adeptio Core для завершения операции</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>(должно быть9077 в главной сети)</translation>
    </message>
    <message>
