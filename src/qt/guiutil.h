...
/** Utility functions used by the ADE Qt UI.
 */
namespace GUIUtil
{
...
// Render ADE addresses in monospace font
...
// Parse "adeptio:" URI into recipient object, return true on successful parsing
