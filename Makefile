...
ACLOCAL = ${SHELL} /tmp/adeptio/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/adeptio/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/adeptio/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/adeptio/build-aux/missing automake-1.15
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/adeptio/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/adeptio
abs_srcdir = /tmp/adeptio
abs_top_builddir = /tmp/adeptio
abs_top_srcdir = /tmp/adeptio
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/adeptio/build-aux/install-sh
