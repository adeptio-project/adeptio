...
pkgdatadir = $(datadir)/adeptio
pkgincludedir = $(includedir)/adeptio
pkglibdir = $(libdir)/adeptio
pkglibexecdir = $(libexecdir)/adeptio
...
CONFIG_HEADER = $(top_builddir)/src/config/adeptio-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/adeptio-config.h.in \
...
ACLOCAL = ${SHELL} /home/tomand/Documents/coinclone/Adeptio/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/tomand/Documents/coinclone/Adeptio/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/tomand/Documents/coinclone/Adeptio/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/tomand/Documents/coinclone/Adeptio/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/tomand/Documents/coinclone/Adeptio/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = adeptio
PACKAGE_BUGREPORT = http://bit.adeptios
PACKAGE_NAME = ADE Core
PACKAGE_STRING = ADE Core 3.2.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/tomand/Documents/coinclone/Adeptio
abs_srcdir = /home/tomand/Documents/coinclone/Adeptio
abs_top_builddir = /home/tomand/Documents/coinclone/Adeptio
abs_top_srcdir = /home/tomand/Documents/coinclone/Adeptio
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/tomand/Documents/coinclone/Adeptio/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/adeptiod$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/adeptio-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/adeptio-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_adeptio_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_adeptio_coverage.info test_adeptio.info
...
src/config/adeptio-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/adeptio-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/adeptio-config.h
$(top_srcdir)/src/config/adeptio-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/adeptio-config.h src/config/stamp-h1
...
#test_adeptio.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_adeptio -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_adeptio_filtered.info: test_adeptio.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_adeptio_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_adeptio_coverage.info: baseline_filtered_combined.info test_adeptio_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_adeptio_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_adeptio_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_adeptio_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_adeptio.coverage/.dirstamp:  test_adeptio_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_adeptio.coverage/.dirstamp total.coverage/.dirstamp

# ADE: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_adeptio.coverage/ total.coverage/ $(OSX_APP)
