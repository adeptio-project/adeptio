...
ACLOCAL = ${SHELL} /home/tomand/adeptio/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/tomand/adeptio/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/tomand/adeptio/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/tomand/adeptio/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = adeptio-cli
BITCOIN_DAEMON_NAME = adeptiod
BITCOIN_GUI_NAME = adeptio-qt
BITCOIN_TX_NAME = adeptio-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/tomand/adeptio/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = adeptio
PACKAGE_BUGREPORT = www.adeptio.org
PACKAGE_NAME = Adeptio Core
PACKAGE_STRING = Adeptio Core 3.0.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/tomand/adeptio
abs_srcdir = /home/tomand/adeptio
abs_top_builddir = /home/tomand/adeptio
abs_top_srcdir = /home/tomand/adeptio
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/tomand/adeptio/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/adeptio-cli.bash-completion \
	       $(top_srcdir)/contrib/adeptio-tx.bash-completion \
	       $(top_srcdir)/contrib/adeptiod.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/adeptio.ico \
  $(top_srcdir)/share/pixmaps/nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/nsis-wizard.bmp \
  $(top_srcdir)/doc/README_windows.txt

LINUX_PACKAGING = $(top_srcdir)/share/pixmaps/adeptio16.xpm \
  $(top_srcdir)/share/pixmaps/adeptio32.xpm \
  $(top_srcdir)/share/pixmaps/adeptio128.png
...
COVERAGE_INFO = baseline.info \
  test_adeptio_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_adeptio_coverage.info test_adeptio.info
...
$(OSX_APP)/Contents/MacOS/Adeptio-qt: all-recursive
	$(MKDIR_P) $(@D)
...
#test_adeptio.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_adeptio -o $@
...
#functional_test.info: test_adeptio_filtered.info
...
#test_adeptio_coverage.info: baseline_filtered.info test_adeptio_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_adeptio_filtered.info -o $@

#total_coverage.info: test_adeptio_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_adeptio_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_adeptio.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
